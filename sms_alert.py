...
def send_sms_alert(lat, lon, event_type):
    ...
    event_messages = {
        "SOS_EMERGENCY": "SOS BUTTON PRESSED! I am in immediate danger and need help.",
        "PIR_MOTION": "UNUSUAL ACTIVITY DETECTED! My handbag has detected potential theft or a fall.",
        "LOCATION_CHECK": "Periodic location check initiated.",
